...
Reservoirs.fyi is a full-stack web application written using React and JavaScript on the frontend, and Node.js, Express and Redis on the backend. It gets data from the public cdec.water.ca.gov API.
